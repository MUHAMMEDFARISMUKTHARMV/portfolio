  ...
  return (
    <section id="journey" className="py-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <span className="font-mono text-xs text-accent-light tracking-widest uppercase mb-3 block">Journey</span>
          <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-normal text-fg">My ML Journey at a Glance</h2>
